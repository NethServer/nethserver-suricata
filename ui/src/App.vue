    ...
    >
      <ul class="list-group panel">
        ...
        <li
          ...
          v-bind:class="[getCurrentPath('configuration') ? 'active' : '', 'list-group-item']"
        >
...
export default {
  ...
  watch: {
    $route: function(val) {
      localStorage.setItem("suricata-path", val.path);
    }
  },
  mounted() {
    var path = localStorage.getItem("suricata-path") || "/";
